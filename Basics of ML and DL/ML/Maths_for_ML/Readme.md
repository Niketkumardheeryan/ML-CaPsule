...
> The missing prerequisite — now inside the repo.

ML-CaPsule lists "High School Math" as a prerequisite, but never taught it — until now.  
This section fills that gap with three focused Jupyter notebooks that explain the math, show it in code, and connect it **directly to algorithms already in this repo**.
...
## 🗂️How each notebook is structured
