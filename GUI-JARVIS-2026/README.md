...
| `model.h5`         | Pre-trained ML/DL model                |
| `scifi.ui`         | Qt Designer interface                  |
| `rec.qrc`          | Qt resource definition                 |
| `rec_rc.py`        | Compiled Qt resources                  |
| `lib/`             | UI images, icons, and graphical assets |
| `Material/`        | Additional project media               |
| `requirements.txt` | Python dependencies                    |
| `.env.example`     | Environment variable template          |
| `.gitignore`       | Files excluded from Git                |
| `hahaha.wav`       | Audio feedback asset                   |
