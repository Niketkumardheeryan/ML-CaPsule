(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([[880],{
...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(51606);
...
async function main() {
  ...
  let baseMods = [
      __webpack_require__(79595),
  __webpack_require__(14118),
  __webpack_require__(5357),
  __webpack_require__(71684),
  __webpack_require__(58075),
  __webpack_require__(98150),
  __webpack_require__(87693),
  
      (__webpack_require__(84217)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(35944)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(53345),
  __webpack_require__(3302),
  
      (__webpack_require__(28568)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(18309)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(84398),
  
      (__webpack_require__(7851)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(15687)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(28315)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(63161)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(38060)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(61717),
  __webpack_require__(83148),
  __webpack_require__(13002),
  __webpack_require__(26369),
  
      (__webpack_require__(51178)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(20970),
  __webpack_require__(75687),
  __webpack_require__(89291),
  
      (__webpack_require__(91018)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(29467),
  __webpack_require__(94400),
  __webpack_require__(85541),
  __webpack_require__(46538),
  __webpack_require__(57965),
  __webpack_require__(35464),
  __webpack_require__(3734),
  __webpack_require__(43238),
  __webpack_require__(46971),
  ...
  switch (page) {
    ...
    case '/tree': {
      baseMods = baseMods.concat([
        __webpack_require__(69508),
  __webpack_require__(64984),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(19941),
  
      (__webpack_require__(26402)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(30689),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(12242),
  __webpack_require__(69508),
  
      (__webpack_require__(26340)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:display-registry',
      ...
      __webpack_require__(54729),
  __webpack_require__(96831),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(42285)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(91442)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(56981).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(90423).IServiceManager);
...
var documentsearch_extension_style_base = __webpack_require__(46806);
...
//# sourceMappingURL=880.7e453db0a3010664fbc4.js.map?v=7e453db0a3010664fbc4